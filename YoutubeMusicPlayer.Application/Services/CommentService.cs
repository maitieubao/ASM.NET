...
public class CommentService : ICommentService
{
    ...
    {
        // Optimized: Single SQL query with Include to avoid loading all users/likes into RAM
        ...
        // Fetch only likes related to these comments
        ...
        // Build recursion map
        return BuildCommentTree(comments, likes, currentUserId);
    }
