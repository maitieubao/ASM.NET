...
public class AdminSubscriptionController : Controller
{
    ...
    public AdminSubscriptionController(ISubscriptionService subscriptionService, IDashboardService dashboardService)
    {
    ...
    [HttpGet]
    public async Task<IActionResult> Transactions(CancellationToken ct = default)
    {
        var dashboard = await _dashboardService.GetStatsAsync(ct);
        return View(dashboard.RecentPayments);
    }
